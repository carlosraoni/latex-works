...
other probabilistic algorithms (see Cohen et al.(1997) and Honkala and Östergard(1997)). 
  \end{itemize}
}
...
{%\footnotesize
  \begin{itemize}
		...
		\item Carnielli at al.(1995) and Östergard(1997) present the use metaheuristics to find upper bounds to $R-covering$ codes. 		\item We applied a reactive variation of Tabu Search(TS) for covering codes problems.
