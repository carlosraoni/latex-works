...
\begin{frame}
  \frametitle{Códigos de Cobertura: Limites e Heurísticas}
{	
\begin{itemize}
	...
	\end{enumerate}
	\item<5-> Apresentamos uma aplicação da metaeurística Busca Tabu Reativa (BTR)
	aos problemas citados.
	\item<6-> O trabalho também proprõe uma nova heurística baseada em duas 
	técnicas já bastante estabelecidas na área de otimização combinatória, a geração atrasada de colunas e as buscas locais.
\end{itemize}
}
\end{frame}
...
\begin{itemize}
	\item<1-> Os primeiros trabalhos que usaram heurísticas de busca local para determinar limites para os códigos clássicos de cobertura utlizavam quase que exclusivamente a metaeurística \textsl{Simulated Annealing}.
		...
		186$.
		\end{enumerate}
	\item<2-> \"Osterg\aa rd 1991, Wille 1990, Aarts et. al 1992 e Van Lint 1989
	obtiveram inúmeros outros recordes com o simulated annealing.
	...
	\item<5-> W.A. Carnielli et. al 1998 também apresentaram uma aplicação da busca
	tabu para o problema dos códigos de cobertura.
	\item<6-> A principal diferença entre os trabalhos usando busca tabu foi o
