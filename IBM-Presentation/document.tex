...
\begin{itemize}
	...
	\item<5-> W.A. Carnielli et. al 1998 também apresentaram uma aplicação da busca	tabu para o problema dos códigos de cobertura.
	\item<6-> A principal diferença entre os trabalhos usando busca tabu foi o espaço de busca utilizado.
\end{itemize}
}
...
\subsection{CGIH Algorithms}

\begin{frame}
  \frametitle{CGIH Algorithms}
{
...
\begin{frame}
  \frametitle{Successive Transformations Algorithm}
{	
{\bf Inicializações.}
\begin{itemize}
...
\subsection{CGIH on Covering Codes Problems}

\begin{frame}
  \frametitle{CGIH on Covering Codes Problems}
{
...
\begin{frame}
  \frametitle{Column Generation Model}
{
...
\begin{frame}
  \frametitle{The Pricing Problem}
{
...
\begin{frame}
  \frametitle{Avoiding Solvers Use}
{
...
\begin{frame}
  \frametitle{Column Selection Criteria}
{
...
\subsection{Initial Short Coverings Bounds via Reactive Tabu Search}

\begin{frame}
  \frametitle{Initial Short Coverings Bounds via Reactive Tabu Search}
{
